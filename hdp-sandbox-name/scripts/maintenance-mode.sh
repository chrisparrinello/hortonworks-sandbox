...
#  curl -u admin:admin -H 'X-Requested-By: ambari' -X PUT -d '{"RequestInfo":{"context":"Turn On Maintenance Mode for '$component'"},"Body":{"HostRoles":{"maintenance_state":"ON"}}}' http://localhost:8080/api/v1/clusters/Sandbox/hosts/sandbox-hdp.hortonworks.com/host_components/$component
#done
